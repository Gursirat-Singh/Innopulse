...
import { captchaStore } from "./captcha-store.js";
 ...
 */
export function createCaptcha(): { id: string; text: string; svg: string } {
 ...
 */
export function getCaptchaSvg(id: string): string | null {
  const entry = captchaStore.get(id)
